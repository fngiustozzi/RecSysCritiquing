...
*/
    ...
    function get_stats()
    {
        ...
        function rate_movie(userid, movieid, rating)
        {
              //var rating1;
              //rating1 = document.getElementsByName("rank"+movieid)[0].value;
              var e = document.getElementById("rank"+movieid);
              var strUser = e.options[e.selectedIndex].value;
              $.post('response.php', {usrid:userid, id_lo: movieid, rat: strUser}, 
              function(data){
                alert(data);
              }
              );
            alert($_POST['rank'+movieid]);
        }

        function refresh(lang_cri)
        {
              //var rating1;
              //rating1 = document.getElementsByName("rank"+movieid)[0].value;
              var e = document.getElementById("language_critic");
              var strUser = e.options[e.selectedIndex].value;
              $.post('general.php', {language_critic:lang_cri}, 
              function(data){
                alert(data);
              }
              );
